  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      if (res.token) {
        ...
        navigate("/dashboard/patient");
      } else throw new Error("Token not received from Google login");
    } catch {
  ...
  return (
    <div className="login-wrapper">
      <div className="login-card">
        ...
        <p className="login-subtitle">Log in to continue your healing journey</p>
          ...
          <div className="form-group">
            ...
            <div className="password-input-wrapper">
              ...
              <span className="toggle-eye"
                onClick={() => setFields(p => ({ ...p, showPassword: !p.showPassword }))}>
                {fields.showPassword ? "🙈" : "👁"}
              </span>
            </div>
        ...
        <div className="google-login">
          <GoogleLogin
            ...
            useOneTap theme="outline" size="large" shape="pill" text="signin_with"
          />
        ...
        <div className="auth-links">
          ...
          <a href="/auth/register/patient">Don’t have an account? Sign Up</a>
        </div>
      </div>
    </div>
  );
